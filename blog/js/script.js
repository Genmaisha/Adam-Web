                                    ...
                                    a && t.forEach(function (t, i) {
                                        ...
                                        ! function (t) {
                                            var e = t.store,
                                                ...
                                                T = c.id;
                                            V(E, a) && (T = U(n, T));
                                            var O = v.hasBoundaryNodes && i ? y.getClosestElement(i, w) : null;
    ...
    r.define("brand", t.exports = function (t) {
        ...
        return n.ready = function () {
            ...
            /\.webflow\.io$/i.test(p) && c.hostname !== p && (u = !0), u && !s && (e = e || (n = t('').attr("href", "https://webflow.com?utm_campaign=brandjs"), r = t("<img>").attr("src", "https://d3e54v103j8qbb.cloudfront.net/img/webflow-badge-icon.f67cd735e3.svg").attr("alt", "").css({
                marginRight: "8px",
                width: "16px"
            }), a = t("<img>").attr("src").attr(""), n.append(r, a), n[0]), d(), setTimeout(d, 500), t(i).off(f, l).on(f, l))
        }, n
    })
}, function (t, e, n) {
    "use strict";
        ...
        T = function (t, e) {
            ...
            for (var S = 0, R = i.length; S < R; S++) {
                ...
                if (0 === S && (_ = C[0]), A >= N) {
                    ...
                    var L = i[S + 1],
                        P = L && A !== N;
                    m = P ? L.actionItems[0] : null, P && (I = N / 100, T = (L.keyframe - N) / 100)
                }
            }
            var D = {};
            if (_ && !m)
            ...
            "actionItemGroups": [{
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "duration": 500,
                        "target": {
                            "id": "6308b165ad70e33435577482|d54f3dbf-fa4c-4ac9-f4f7-fe1710692588"
                        },
                        "value": 0,
                        "unit": ""
                    }
